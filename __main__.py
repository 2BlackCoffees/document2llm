...
parser.add_argument('--skip_slides', type=csv_, help='Specify slides to skip: 1,2-5,8')
...
ApplicationService(from_document, slides_to_skip, args.detailed_analysis, reviewer_name, args.simulate_calls_only, logging_level,\
